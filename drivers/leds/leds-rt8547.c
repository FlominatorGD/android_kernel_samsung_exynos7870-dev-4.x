                                ...
                                struct rt8547_platform_data *pdata)
{
	...
	pdata->flash_current_value = RT8547_FLASH_CURRENT_1000mA;
	pdata->movie_current_value = RT8547_MOVIE_CURRENT_250mA;
	pdata->pre_current_value = pdata->movie_current_value;
