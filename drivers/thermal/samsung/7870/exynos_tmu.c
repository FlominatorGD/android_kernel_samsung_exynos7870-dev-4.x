...
static int exynos_tmu_probe(struct platform_device *pdev)
{
	...
	/*
	 * The 3.18 driver deferred the probe until a cpufreq driver was
	 * available because its cooling registration required the cpu
	 * frequency table. The 4.14 adaptation only registers the cpufreq
...
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:exynos7870-tmu");
